...
class Topology:
    ...
    def __init__(self, frame_id: int, feature: dict):
        ...
        self.ego_history = feature['ego_history']
        self.agent_feature = feature['agent_feature']
        self.agent_attribute_feature = feature['agent_attribute_feature']

    def preprocess(self) -> np.ndarray:
        """
        预处理拓扑信息，目前仅作为占位实现
        ego -> (x, y, heading, v, acc)
        obs -> (x, y, heading, v, acc, length, width, type)
        """
